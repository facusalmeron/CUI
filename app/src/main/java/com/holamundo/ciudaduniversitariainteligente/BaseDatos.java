...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public void cargaDB(SQLiteDatabase sqLiteDatabase){
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 23, "-31.639900", "-60.672071", "FICH", 1, "Oficina Relaciones Institucionales", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 24, "-31.639873", "-60.672071", "FICH", 1, "Oficina Decanato", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 25, "-31.639853", "-60.672151", "FICH", 1, "Oficina Alumnado", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 26, "-31.639799", "-60.672151", "FICH", 1, "Oficina Mesa de Entradas", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 27, "-31.639773", "-60.672151", "FICH", 1, "Baños", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 28, "-31.639773", "-60.672198", "FICH", 1, "Lab. Electronica", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 31, "-31.639847", "-60.672550", "FICH", 1, "Lab. 3 - 4", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 32, "-31.639956", "-60.672550", "FICH", 1, "Escalera", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 33, "-31.639956", "-60.672302", "FICH", 1, "Oficina Bedelia", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 34, "-31.639954", "-60.672269", "FICH", 2, "Escalera", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 35, "-31.639954", "-60.672109", "FICH", 2, "Lab. de Quimica", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 36, "-31.639954", "-60.672088", "FICH", 2, "Oficina Secretaria Extensión", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 44, "-31.639869", "-60.672085", "FICH", 3, "Oficina Cátedra Matematica", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 49, "-31.639969", "-60.672966", "FCBC", 0, "Oficina Bedelia", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 50, "-31.639969", "-60.673062", "FCBC", 0, "Oficina Mesa de entradas", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 51, "-31.639773", "-60.672587", "FCBC", 1, "Aula 1.1 - 1.2 - 1.3", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 52, "-31.639956", "-60.672605", "FCBC", 1, "Oficina Cátedra Matemática Gral", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 53, "-31.639956", "-60.672699", "FCBC", 1, "Lab. Química Orgánica I - II", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 54, "-31.639956", "-60.672795", "FCBC", 1, "Oficina Cátedra Química Orgánica", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 55, "-31.639956", "-60.672838", "FCBC", 1, "Escalera", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 56, "-31.639956", "-60.672884", "FCBC", 1, "Aula Sala Informatica", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 57, "-31.639956", "-60.672951", "FCBC", 1, "Oficina Alumnado", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 58, "-31.639843", "-60.672838", "FCBC", 1, "Baños", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 59, "-31.639954", "-60.672429", "FCBC", 2, "Oficina Cátedra Quimica Analitica", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 72, "-31.639954", "-60.672838", "FCBC", 2, "Oficina Cátedra Qca Gral", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 82, "-31.639958", "-60.672926", "FCBC", 3, "Oficina Decanato", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 86, "-31.639720", "-60.671650", "FICH", 1, "Lab. 5", -1));

        //**************************************************************************************
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 87, "-31.639969", "-60.673279", "FADU", 0, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 88, "-31.640172", "-60.673279", "FADU", 0, "Entrada FADU", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 89, "-31.640172", "-60.673351", "FADU", 0, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 90, "-31.640210", "-60.673351", "FADU", 0, "Oficina Bedelia", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 91, "-31.640128", "-60.673351", "FADU", 0, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 92, "-31.640128", "-60.673395", "FADU", 0, "Cantina", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 93, "-31.640128", "-60.673532", "FADU", 0, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 94, "-31.640128", "-60.673583", "FADU", 0, "Escalera", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 95, "-31.640198", "-60.673583", "FADU", 0, "Baños", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 96, "-31.640071", "-60.673532", "FADU", 0, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 97, "-31.640071", "-60.673592", "FADU", 0, "Oficina Cead y Libreria", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 98, "-31.640071", "-60.673658", "FADU", 0, "Aula Salon Actos", -1));

        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 99, "-31.640119", "-60.673602", "FADU", 1, "Escalera", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 100, "-31.640181", "-60.673602", "FADU", 1, "Baños", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 101, "-31.640067", "-60.673602", "FADU", 1, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 102, "-31.640044", "-60.673602", "FADU", 1, "Oficina Area Administrativa", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 103, "-31.640044", "-60.673646", "FADU", 1, "Oficina Area Gestion", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 104, "-31.640067", "-60.673474", "FADU", 1, "Oficina Asuntos Estudiantiles", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 105, "-31.640067", "-60.673350", "FADU", 1, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 106, "-31.640041", "-60.673350", "FADU", 1, "Oficina Alumnado", -1));

        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 107, "-31.640116", "-60.673608", "FADU", 2, "Escalera", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 108, "-31.640178", "-60.673608", "FADU", 2, "Baños", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 111, "-31.640070", "-60.673802", "FADU", 2, "Oficina Secretaria Posgrado", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 115, "-31.640117", "-60.6736077", "FADU", 3, "Escalera", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 116, "-31.640175", "-60.6736077", "FADU", 3, "Baños", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 117, "-31.640258", "-60.6736077", "FHUC", 3, "Aula Ecotoxicologia", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 118, "-31.640258", "-60.6737478", "FADU", 3, "Aula Taller 4", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 119, "-31.640117", "-60.6735775", "FADU", 3, "Fotocopiadora", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 123, "-31.640113", "-60.673581", "FADU", 4, "Escalera", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 124, "-31.640174", "-60.673581", "FADU", 4, "Baños", -1));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 131, "-31.640226", "-60.671913", "Ciudad Universitaria", 0, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 132, "-31.640226", "-60.673279", "Ciudad Universitaria", 0, "", -1));

        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 133, "-31.640210", "-60.673491", "FHUC", 0, "Fotocopiadora", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 134, "-31.640198", "-60.673491", "FHUC", 0, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 135, "-31.640272", "-60.673583", "FHUC", 0, "Aula 3", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 136, "-31.640272", "-60.673496", "FHUC", 0, "Aula 2", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 137, "-31.640272", "-60.673399", "FHUC", 0, "Aula 1", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 138, "-31.640272", "-60.673692", "FHUC", 0, "Aula 4", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 139, "-31.640272", "-60.673726", "FHUC", 0, "Aula 5 y 8", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 140, "-31.640272", "-60.673818", "FHUC", 0, "Aula 6 y 7", -1));

        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 141, "-31.640260", "-60.673602", "FHUC", 1, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 142, "-31.640260", "-60.673821", "FHUC", 1, "Oficina Alumnado", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 143, "-31.640304", "-60.673821", "FHUC", 1, "Oficina Mesa Entrada", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 144, "-31.640304", "-60.673769", "FHUC", 1, "Oficina Secretaria Administrativa", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 145, "-31.640304", "-60.673559", "FHUC", 1, "Oficina Decano", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 146, "-31.640260", "-60.673559", "FHUC", 1, "", -1));

        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 147, "-31.640225", "-60.673608", "FHUC", 2, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 148, "-31.640261", "-60.673608", "FHUC", 2, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 149, "-31.640261", "-60.673658", "FHUC", 2, "Aula 12", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 150, "-31.640261", "-60.673722", "FHUC", 2, "Aula 11", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 151, "-31.640261", "-60.673745", "FHUC", 2, "Aula 9", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 152, "-31.640261", "-60.673834", "FHUC", 2, "Aula 10", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 153, "-31.640225", "-60.673427", "FHUC", 2, "", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 154, "-31.640272", "-60.673427", "FHUC", 2, "Aula 14", -1));

        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 155, "-31.640258", "-60.673683", "FHUC", 3, "Aula 15", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 156, "-31.640258", "-60.673632", "FHUC", 3, "Aula Microscopia", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 157, "-31.640258", "-60.673537", "FHUC", 3, "Lab. 1", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 158, "-31.640258", "-60.673425", "FHUC", 3, "Lab. 2", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 159, "-31.640258", "-60.673400", "FHUC", 3, "Lab. 3", -1));
        sqLiteDatabase.execSQL(String.format(INSERT_PUNTO_TEMPLATE, 160, "-31.640258", "-60.673363", "FHUC", 3, "Lab. Fisico Quimica", -1));

        //**************************************************************************************

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 0, 131));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 1, 131));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 88, 132));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 90, 133));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 95, 134));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 95, 135));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 99, 107));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 100, 99));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 100, 141));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 108, 147));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 117, 156));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 117, 157));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 118, 155));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 131, 1));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 131, 0));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 131, 132));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 132, 88));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 132, 131));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 133, 90));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 134, 95));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 135, 95));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 135, 136));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 135, 138));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 136, 135));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 136, 137));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 137, 136));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 138, 135));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 138, 139));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 139, 138));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 139, 140));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 140, 139));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 141, 100));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 141, 142));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 141, 146));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 142, 141));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 144, 145));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 145, 144));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 145, 146));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 146, 141));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 146, 145));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 147, 108));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 147, 148));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 147, 153));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 148, 147));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 153, 147));
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 153, 154));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 154, 153));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 155, 118));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 156, 117));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 157, 117));
        ...
        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 159, 160));

        sqLiteDatabase.execSQL(String.format(INSERT_CONEXION_TEMPLATE, 160, 159));
